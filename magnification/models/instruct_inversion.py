...
def select_random_combination(tokens):
    all_combinations = []
    num_tokens = len(tokens)

    # Generate all possible combinations from length 1 to num_tokens
    for r in range(1, num_tokens + 1):
        combinations_r = list(itertools.combinations(tokens, r))
